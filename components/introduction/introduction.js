...
const Introduction = React.forwardRef((props, ref) => {
  ...
  return (
    <Container data-scroll-section ref={ref} id="introduction">
      <Circle>
        <CircleInner />
      </Circle>
      <DetailsWrapper>
         ...
         <ContentWrapper>
          <MenuWrapper variants={container} initial="initial" animate="animate" data-scroll>
          ...
          <MainText data-scroll data-scroll-speed={-2} variants={container} initial="initial" animate="animate">
            <motion.p variants={item} data-scroll>I&lsquo;m <span>Kate Nguyen</span>,</motion.p>
            <motion.p variants={item} data-scroll>a website developer</motion.p>
          </MainText>
        </ContentWrapper>
      </DetailsWrapper>
